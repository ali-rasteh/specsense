...
class params_class(object):
    def __init__(self):
        ...
        self.sig_size_min=(20,)
        self.sig_size_max=(20,)
        ...
        self.model_load_path='./model/model_weights_30.pth'
        ...
        self.sw_snrs = np.array(self.sw_snrs)
...
if __name__ == '__main__':
    ...
    if params.sweep_snr:
        ...
        det_rate = ss_det.sweep_snrs(snrs=params.sw_snrs, n_sigs_min=params.sw_n_sigs_min, n_sigs_max=params.sw_n_sigs_max, sig_size_min=params.fixed_size_t, sig_size_max=params.fixed_size_t)
        print("ML detection rate for SNRs: {}".format(det_rate))
        # det_rate= {0.01: 0.0, 0.027825594022071243: 0.0, 0.0774263682681127: 0.0, 0.21544346900318834: 0.0, 0.5994842503189409: 0.0, 1.6681005372000592: 0.2916666666666667, 4.6415888336127775: 0.8976785714285712, 12.915496650148826: 0.9342424242424242, 35.93813663804626: 0.9799999999999999, 100.0: 0.9899999999999999}
        det_rate_snrs['snr_ML'] = det_rate.copy()

    if params.sweep_size:
        det_rate = ss_det.sweep_sizes(sizes=params.sw_sizes, n_sigs_min=params.sw_n_sigs_min, n_sigs_max=params.sw_n_sigs_max, snrs=params.fixed_snr_t)
        print("ML detection rate for signal sizes: {}".format(det_rate))
        # det_rate= {(1,): 0.0, (2,): 0.55, (4,): 0.38608168360977346, (7,): 0.7642857142857142, (12,): 0.9038095238095237, (21,): 0.9318354978354977, (35,): 0.9503699303699303, (59,): 0.9833842734092805, (100,): 0.9772513253587801}
