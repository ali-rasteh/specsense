...
if __name__ == '__main__':
    ...
    params = {'fs': fs, 'sharp_bw': sharp_bw, 'base_order_pos': base_order_pos,
              ...
              'snr': snr, 'ridge_coeff': ridge_coeff, 'sig_sel_id': sig_sel_id, 'rx_sel_id': rx_sel_id, 'plot_level': plot_level}
    fir_separate_ins = fir_separate(rx, sigs, sig_bw, sig_amp, sig_cf, spatial_sig, params)

    fir_separate_ins.wiener_filter()
    fir_separate_ins.basis_filter()
